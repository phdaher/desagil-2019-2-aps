...
public class View extends JPanel implements ActionListener {
    ...
    // a representação gráfica dos inputs do gate atualmente
    // selecionado. Esse menu é uma instância de JComboBox
    // e essa representação gráfica do gate é uma
    ...
    public View(LinkedList<Gate> model) {
        ...
        // gráfica do gate atualmente selecionada, que é
    ...
    // representação gráfica do gate identificada por
    ...
    private void addGateView(int index) {
        ...
        // 2. Construir a representação gráfica a partir dele.
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        // ...tirar a atual representação gráfica do gate...
        remove(gateView);

        // ...descobrir qual é o índice do gate selecionado...
        int index = menu.getSelectedIndex();

        // ...e usar o método acima para adicionar o novo.
        addGateView(index);
